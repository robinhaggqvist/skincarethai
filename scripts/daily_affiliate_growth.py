...
def profile_for(item: DraftItem) -> dict[str, object]:
    ...
    if "กันแดด" in title and "สิว" in title and "ผิวมัน" in title:
        return {
            "slug": "acne-sunscreen-oily-skin",
            "path": ["topics"],
            "subtitle": "เลือกกันแดดสำหรับคนเป็นสิวและผิวมันจากการใช้งานจริง",
            "summary": "บทความนี้แยกโจทย์กันแดดสำหรับผิวมันและเป็นสิวออกจากคำโฆษณา โดยดูเนื้อสัมผัส การอุดตัน ความสบายผิว และการเติมระหว่างวัน",
            "best_for": ["ผิวมันและเป็นสิวง่าย", "คนที่ไม่ชอบกันแดดเหนอะหนะ", "คนที่ต้องเติมกันแดดระหว่างวัน"],
            "cautions": ["คำว่า oil-free ไม่รับประกันว่าจะเหมาะกับทุกคน", "ควรทดสอบทีละผลิตภัณฑ์ถ้าผิวกำลังระคายเคือง"],
            "what_to_look_for": ["เนื้อบางและเซ็ตตัวได้จริง", "ล้างออกได้โดยไม่ต้องถูแรง", "มีข้อมูลส่วนผสมและวิธีใช้ชัดเจน"],
            "related": [("/sunscreen.html", "รีวิวกันแดด"), ("/acne.html", "สกินแคร์สำหรับคนเป็นสิว")],
            "faq": [("ผิวมันเป็นสิวต้องเลือกกันแดดแบบไหน?", "เริ่มจากสูตรที่สบายผิว ไม่หนัก และดูว่าการใช้ต่อเนื่องทำให้เกิดการอุดตันหรือไม่"), ("ต้องดูแค่คำว่า oil-free ไหม?", "ไม่ควรดูคำเดียว ควรดูเนื้อสัมผัส การล้างออก และปฏิกิริยาผิวจริงร่วมกัน")],
        }
    if "กันแดด" in title and "สิว" in title and ("300" in title or "งบ" in title):
        return {
            "slug": "acne-sunscreen-budget",
            "path": ["topics"],
            "subtitle": "ไกด์เลือกกันแดดคนเป็นสิวในงบที่ควบคุมได้",
            "summary": "การเลือกกันแดดงบจำกัดควรดูต้นทุนต่อการใช้จริง ความสบายผิว และโอกาสใช้ได้ต่อเนื่อง ไม่ใช่ดูราคาต่อชิ้นอย่างเดียว",
            "best_for": ["คนที่มีงบจำกัด", "นักเรียนและนักศึกษา", "คนที่อยากเทียบความคุ้มก่อนซื้อ"],
            "cautions": ["ราคาถูกไม่ได้แปลว่าเหมาะกับผิวทุกคน", "อย่าลดปริมาณที่ใช้เพื่อประหยัดจนการปกป้องไม่เพียงพอ"],
            "what_to_look_for": ["ปริมาณต่อชิ้นและราคาต่อการใช้", "เนื้อสัมผัสที่ใช้ซ้ำได้จริง", "ข้อมูลการปกป้องและคำเตือนที่ตรวจสอบได้"],
            "related": [("/sunscreen.html", "รีวิวกันแดด"), ("/topics/กันแดดคนเป็นสิวควรเลือกแบบไหน-เนื้อสัมผัสและส่วนผสมที่ควรมองหา/", "กันแดดสำหรับคนเป็นสิว")],
            "faq": [("งบไม่เกิน 300 บาทเลือกอย่างไร?", "กำหนดปริมาณที่ต้องใช้ก่อน แล้วเทียบต้นทุนต่อการใช้กับความสบายผิวและความสม่ำเสมอ"), ("ควรซื้อขนาดทดลองไหม?", "เหมาะเมื่อผิวไว เพราะช่วยทดสอบการระคายเคืองก่อนซื้อขนาดใหญ่")],
        }
    if "กันแดดเด็ก" in title and "แพ้ง่าย" in title:
        return {
            "slug": "kids-sunscreen-sensitive-skin",
            "path": ["topics"],
            "subtitle": "เลือกกันแดดเด็กผิวแพ้ง่ายโดยเน้นความปลอดภัยและการใช้จริง",
            "summary": "กันแดดเด็กผิวแพ้ง่ายควรพิจารณาอายุ บริเวณที่ใช้ การระคายเคือง และความสามารถในการทาซ้ำ มากกว่าการไล่ตามคำโฆษณา",
            "best_for": ["ผู้ปกครองเด็กผิวไว", "คนที่ต้องเลือกกันแดดสำหรับกิจกรรมนอกบ้าน", "คนที่อยากเริ่มจากเกณฑ์ที่เข้าใจง่าย"],
            "cautions": ["ควรตรวจอายุที่เหมาะสมบนฉลาก", "ทดสอบบริเวณเล็กๆ ก่อนใช้กว้างขึ้น", "หลีกเลี่ยงบริเวณรอบดวงตาและผิวที่มีแผล"],
            "what_to_look_for": ["ฉลากและคำแนะนำตามอายุ", "สูตรที่ล้างออกได้ง่าย", "ความร่วมมือของเด็กในการทาซ้ำ"],
            "related": [("/sunscreen.html", "รีวิวกันแดด"), ("/topics/กันแดดเด็กเลือกยังไง-รวมแนวทางเลือกแบบปลอดภัยและใช้จริง/", "แนวทางเลือกกันแดดเด็ก")],
            "faq": [("เด็กผิวแพ้ง่ายควรเริ่มอย่างไร?", "เริ่มจากทดสอบบริเวณเล็กๆ และเลือกสูตรตามอายุพร้อมสังเกตอาการ"), ("ต้องทาซ้ำไหม?", "ควรทำตามฉลากและกิจกรรม โดยเฉพาะเมื่อเหงื่อออกหรือเล่นน้ำ")],
        }
    if "เซรั่ม" in title and ("วิตามินซี" in title or "รอยสิว" in title):
        return {
            "slug": "vitamin-c-serum-acne-marks",
            "path": ["topics"],
            "subtitle": "เลือกเซรั่มวิตามินซีสำหรับรอยสิวโดยดูสูตรและความสม่ำเสมอ",
            "summary": "เซรั่มวิตามินซีสำหรับรอยสิวควรดูความเข้ากันกับผิว ความเสถียรของสูตร และการใช้กันแดดร่วมกัน ไม่ใช่ดูเปอร์เซ็นต์สูงที่สุด",
            "best_for": ["คนที่มีรอยสิวและผิวหมอง", "มือใหม่ที่อยากเริ่มวิตามินซี", "คนที่ต้องการเทียบเนื้อสัมผัสและวิธีใช้"],
            "cautions": ["เปอร์เซ็นต์สูงอาจระคายเคืองได้", "ผิวที่กำลังอักเสบควรลดจำนวน active", "ต้องใช้กันแดดร่วมด้วย"],
            "what_to_look_for": ["บรรจุภัณฑ์ที่ช่วยลดแสงและอากาศ", "คำแนะนำการเก็บรักษา", "เนื้อสัมผัสที่ใช้ต่อเนื่องได้"],
            "related": [("/topics/vitamin-c/", "คู่มือวิตามินซี"), ("/whitening.html", "ดูแลผิวกระจ่างใส")],
            "faq": [("วิตามินซีช่วยรอยสิวได้ไหม?", "อาจช่วยให้สีผิวดูสม่ำเสมอขึ้นเมื่อใช้สม่ำเสมอและป้องกันแดด แต่ไม่ใช่การรักษาสิวโดยตรง"), ("เริ่มใช้บ่อยแค่ไหน?", "เริ่มตามคำแนะนำของผลิตภัณฑ์และลดความถี่หากมีอาการแสบหรือลอก")],
        }
    if "ครีมหน้าใส" in title and "แพ้ง่าย" in title:
        return {
            "slug": "brightening-cream-sensitive-skin",
            "path": ["topics"],
            "subtitle": "ครีมหน้าใสสำหรับผิวแพ้ง่าย: ดูแลความกระจ่างใสโดยไม่เร่งผิว",
            "summary": "ผิวแพ้ง่ายควรเริ่มจากการลดการระคายเคืองและเสริมความชุ่มชื้น ก่อนเลือกครีมที่เน้นความกระจ่างใสหรือสาร active หลายชนิด",
            "best_for": ["ผิวแห้งหรือแพ้ง่าย", "คนที่เคยแสบจากครีมหน้าใส", "คนที่อยากจัดรูทีนให้น้อยชิ้นลง"],
            "cautions": ["ทดสอบผลิตภัณฑ์ก่อนใช้ทั่วหน้า", "อย่าซ้อน active หลายตัวในคืนเดียว", "หากมีผื่นหรือแสบต่อเนื่องควรหยุดใช้"],
            "what_to_look_for": ["ส่วนผสมที่เรียบง่าย", "เนื้อที่ไม่ทำให้ผิวตึง", "คำแนะนำการใช้และคำเตือนชัดเจน"],
            "related": [("/moisturizer.html", "รีวิวมอยเจอร์ไรเซอร์"), ("/topics/รีวิวครีมหน้าใส-ในมุมที่คนไทยกำลังสนใจ/", "รีวิวครีมหน้าใส")],
            "faq": [("ผิวแพ้ง่ายใช้ครีมหน้าใสได้ไหม?", "ได้หากเลือกสูตรที่เหมาะและเริ่มทีละอย่างโดยสังเกตผิว"), ("ต้องใช้กี่ตัวถึงเห็นผล?", "ไม่จำเป็นต้องหลายตัว ความสม่ำเสมอและการป้องกันแดดสำคัญกว่า")],
        }
...
def mark_calendar_published(selected_titles: set[str]) -> bool:
    ...
    for block in blocks:
        if any(title in block for title in selected_titles):
            block = re.sub(r"(?m)^- Status:\s*draft\s*$", "- Status: published", block, count=1)
        updated_blocks.append(block)
    updated = "".join(updated_blocks)
    if updated != text:
